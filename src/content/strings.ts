...
export const STRINGS: Record<string, string> = {
  ...
  setAmbientLife: 'Ambient cavern life (cosmetic)',
  bindTitle: 'REBIND KEYS',
  bindPress: 'press a key… (ESC cancels)',
  bindReset: 'Reset keys to scheme default',
  bindUnbound: '—',
  bindLeft: 'Move left',
  ...
  // --- Co-op ---
  coop: 'Co-op',
  coopTitle: 'CO-OP EXPEDITION CREW',
  coopBlurb:
    'Two to six rigs, one mine, one shared account. Connect directly over your LAN — no servers, just codes.',
  coopHost: 'Host a crew',
  coopJoin: 'Join a crew',
  coopLanNote: 'Direct connection (WebRTC) · works on a LAN, even offline · no accounts',
  coopAddSeat: 'Add a seat',
  coopStart: 'Start digging',
  coopCopy: 'Copy',
  coopAccept: 'Accept',
  coopConnected: '✓ connected',
  coopSendOffer: '1. Have your friend scan this invite — or share the link:',
  coopPasteAnswer: '2. Scan or paste their reply code:',
  coopPasteOffer: "Paste the host's invite code (or tap their invite link):",
  coopSendAnswer: 'Show this reply to the host to scan — or send it back — then wait…',
  coopShareLink: 'Share link',
  coopCopyLink: 'Copy link',
  coopScanReply: 'Scan reply',
  coopScanTitle: 'SCAN REPLY CODE',
  coopScanHint: "Point the camera at the reply code on your friend's screen.",
  coopCameraDenied: 'Camera unavailable — paste the reply code instead.',
  coopCancel: 'Cancel',
  coopNewCode: 'New code',
  coopRemoveSeat: 'Remove',
  ...
  coopOfferPh: 'CLDP1.…',
  coopAnswerPh: 'CLDP2.…',
  coopWaiting: 'Waiting for players',
  hudShared: 'SHARED',
  hudOffline: 'OFFLINE',
  ...
  coopModeStory: 'Story',
  coopModeExp: 'Expedition',
  coopModeDaily: 'Daily expedition',
  coopDailyNote: "Today's seeded earth, standard rigs — co-op dailies are never recorded.",
  coopMyRig: 'My rig (unlocks are yours alone — buy gear on the Expedition screen):',
  ...
  coopHostGone: 'HOST DISCONNECTED — session over.',
  coopBadToken: 'That code did not check out.',
  coopVersionMismatch: 'Version mismatch — both players need the same game build.',
  expLoadouts: 'STARTING RIG',
  expModules: 'MODULES',
  expSlots: 'slots',
  expLocked: 'Unlock',
  expNotEnoughCores: 'Not enough drive cores.',
  loStandard: 'Standard Rig',
  loStandardBlurb: 'The stock pod. Honest work.',
  loHeavyRig: 'Heavy Rig',
  loHeavyRigBlurb: 'Bronzite hull + mono turbine. Built to take the deep heat.',
  loProspector: 'Prospector',
  loProspectorBlurb: 'Aurite bit + tuned engine. Finds the money faster.',
  mdThermalFins: 'Thermal Fins',
  mdThermalFinsBlurb: '−25% heat gain.',
  mdAuxTank: 'Auxiliary Tank',
  mdAuxTankBlurb: '+15 L fuel capacity.',
  mdShockAbsorbers: 'Shock Absorbers',
  mdShockAbsorbersBlurb: '−30% fall damage.',
  mdBulkhead: 'Bulkhead Plating',
  mdBulkheadBlurb: '+20 max hull.',
  mdSparkPlug: 'Iridium Spark Plugs',
  mdSparkPlugBlurb: '−15% fuel burned while digging.',
  mdSurveyor: 'Surveyor Suite',
  mdSurveyorBlurb: 'Minimap and ore glyphs, always on.',
  rlTitle: 'RELIC CACHE UNEARTHED',
  rlBlurb: 'Something old hums in the rock. Take exactly one.',
  rlChosen: 'Relic taken',
  rlOreMagnet: 'Ore Magnet',
  rlOreMagnetBlurb: 'Minerals beside every drilled tile pop straight into the hold.',
  rlGasPhase: 'Phase Lattice',
  rlGasPhaseBlurb: 'Gas pockets vent harmlessly around the hull.',
  rlChainDetonate: 'Chain Detonator',
  rlChainDetonateBlurb: 'Every blast reaches one tile further.',
  rlHeatSink: 'Void Heat-Sink',
  rlHeatSinkBlurb: 'Heat builds at half speed.',
