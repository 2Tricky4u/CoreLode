...
export const STRINGS: Record<string, string> = {
  ...
  coopSendOffer: '1. Send this invite code to your friend:',
  coopPasteAnswer: '2. Paste their reply code here:',
  coopPasteOffer: "Paste the host's invite code:",
  coopSendAnswer: 'Send this reply code back to the host, then wait…',
  coopOfferPh: 'CLDP1.…',
  coopAnswerPh: 'CLDP2.…',
